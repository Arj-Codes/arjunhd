import step1 from "../../assets/images/fastag/step01.png"
import step2 from "../../assets/images/fastag/step02.png"
import step3 from "../../assets/images/fastag/step03.png"
import step4 from "../../assets/images/fastag/step04.png"
// import step5 from "../../assets/images/fastag/step05.png"
import step6 from "../../assets/images/fastag/step06.png"
import step7 from "../../assets/images/fastag/step07.png"
import step8 from "../../assets/images/fastag/step08.png"
...
const Recharge = () => {
  ...
  return (
    <div className="w-full h-fit hidden sm:flex flex-col p-3 items-center gap-8 ">
      <div className="title">
        <h1 className="text-4xl font-[500] xxl:text-5xl">FASTag Recharge Guide</h1>
      </div>
      <div className="content__wrapper border guide border-gray-300 flex flex-wrap justify-around gap-28 w-[95%] h-full rounded-2xl p-10">
        {steps.map((s) => (
          <motion.div
            ...
            key={s.id}
          >
            <img src={s.img} alt="" className="xxl:w-[10vw]" />
            <h1 className="font-[600] text-xl xxl:text-3xl">{s.name}</h1>
            <p className="md:w-[15vw] w-[20vw] text-center xxl:text-2xl">{s.text}</p>
          </motion.div>
        ))}
      </div>
    </div>
